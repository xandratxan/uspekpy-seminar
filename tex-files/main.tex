...
\begin{document}
	...
	\begin{frame}
		...
		\begin{enumerate}
			\item Values for a single case
			\item Values for a single case using data files
			\item Values and uncertainties for a single case
			\item Values and uncertainties for a single case using data files
			\item Values and uncertainties for several cases using CSV input file
			\item Values and uncertainties for several cases using Excel input file
		\end{enumerate}
		\bigskip
		\centering
		\href{https://github.com/xandratxan/uspekpy-seminar\#README}{\beamergotobutton{Detailed guide}}
